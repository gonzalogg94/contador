    ...
    return (
        <section className='bg-dark'>
            ...
            <section className='text-center pb-5'>
                ...
                <p className='text-center text-white'>Hola, mi nombre es Gonzalo Gallardo soy Full Stack Developer. Creo que la programación abre las puertas a un mundo donde el límite no son tus conocimientos técnicos sino tu creatividad y tu constancia, con la cual puedes crear lo que quieras. Te comparto a continuación mi Link de GitHub donde puedes ver el repositorio de muchos proyectos en los cuales he trabajado y estoy trabajando, además de algunas skills con las que cuento.</p>
